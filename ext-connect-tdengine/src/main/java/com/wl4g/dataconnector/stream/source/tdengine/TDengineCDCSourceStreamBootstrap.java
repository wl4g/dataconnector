...
/**
 * The {@link TDengineCDCSourceStreamBootstrap}
 *
 * @author James Wong
 * @since v1.0
 **/
public class TDengineCDCSourceStreamBootstrap extends StreamBootstrap<TDengineCDCSourceStream> {

    public TDengineCDCSourceStreamBootstrap(TDengineCDCSourceStream stream,
                                            Object internalTask) {
