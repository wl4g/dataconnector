...
import static com.wl4g.infra.common.tests.integration.manager.GenericITContainerManager.IT_DATA_MOCKERS_TIMEOUT;
...
public class QuickStartDataMocker extends AbstractDataMocker {
    ...
    public static final String KEY_TENANT = "__tenantId__";
    ...
    public void printStatistics() {
        String sb = String.format("%n--- %s :: Print(start) :: %s - %s :: ---%n", getClass().getSimpleName(), tenantId, kafkaServers) +
                "%n       debug true Total : " + statisticsDebugTrueTotal +
                "%n      debug false Total : " + statisticsDebugFalseTotal +
                "%n   connected true Total : " + statisticsConnectedTrueTotal +
                "%n  connected false Total : " + statisticsConnectedFalseTotal +
                "%n          Summary Total : " + statisticsTotal +
                String.format("%n--- %s :: Print(end  ) :: %s - %s :: ---%n", getClass().getSimpleName(), tenantId, kafkaServers);
        out.println(sb);
    }
