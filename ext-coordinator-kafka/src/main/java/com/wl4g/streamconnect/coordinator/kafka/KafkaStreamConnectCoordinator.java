...
package com.wl4g.streamconnect.coordinator.kafka;
...
public class KafkaStreamConnectCoordinator extends AbstractStreamConnectCoordinator {
    ...
    protected KafkaStreamConnectCoordinator(@NotNull Environment environment,
    ...
    protected String generateLocalDiscoveryClientId() {
        try {
            ...
            throw new StreamConnectException("Failed to build kafka discovery local clientId.", ex);
        }
    }
    ...
    protected String generateBroadcastGroupId() {
        try {
            ...
            throw new StreamConnectException("Failed to generate broadcast group id.", ex);
        }
    }
    ...
    protected void initCoordinatorBus() {
        ...
        try (AdminClient adminClient = KafkaUtil.createAdminClient(aConfig)) {
            ...
            throw new StreamConnectException(String.format("Failed to create config bus topic '%s' on '%s'",
    ...
    public static class KafkaBusConfig {
        private @Default String topic = "streamconnect-coordinator-bus-topic";
    ...
    public static class KafkaDiscoveryConfig {
        private @Default String groupId = "streamconnect-coordinator-discovery-group";
        private @Default Map<String, Object> consumerProps = new HashMap<>();
        private @Default Map<String, Object> adminProps = new HashMap<>();
    ...
    public static class KafkaCoordinatorProvider extends CoordinatorProvider {
        ...
        private static KafkaStreamConnectCoordinator SINGLETON;
        ...
        public synchronized IStreamConnectCoordinator obtain(
            ...
            return isNull(SINGLETON) ? (SINGLETON = new KafkaStreamConnectCoordinator(
    ...
    public static final Map<String, Object> DEFAULT_PRODUCER_PROPS = new HashMap<String, Object>() {
        {
    ...
    public static final Map<String, Object> DEFAULT_ADMIN_PROPS = new HashMap<String, Object>() {
        {
            //put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "");
