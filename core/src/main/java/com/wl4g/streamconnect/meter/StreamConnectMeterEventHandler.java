...
/**
 * The {@link StreamConnectMeterEventHandler}
 *
 * @author James Wong
 * @since v1.0
 **/
@AllArgsConstructor
public class StreamConnectMeterEventHandler {
    ...
    public static abstract class AbstractMeterEvent {
        private @NotNull StreamConnectMeter.MetricsName metrics;
    ...
    public static class TimingMeterEvent extends AbstractMeterEvent {
        ...
        public TimingMeterEvent(@NotNull StreamConnectMeter.MetricsName metrics,
            ...
            this(metrics, topic, partition, groupId, subscriberId,
                    StreamConnectMeter.DEFAULT_PERCENTILES, duration, tags);
        }
