...
/**
 * The {@link AbstractStreamConnectConfigurator}
 *
 * @author James Wong
 * @since v1.0
 **/
@AllArgsConstructor
public abstract class AbstractStreamConnectConfigurator implements IStreamConnectConfigurator {
    protected final Environment environment;
    protected final StreamConnectConfiguration config;
    protected final StreamConnectMeter meter;
}
