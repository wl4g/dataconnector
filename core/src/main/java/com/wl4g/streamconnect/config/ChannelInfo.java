...
public class ChannelInfo {
    ...
    public static class PolicySpec {
        ...
        public void validate() {
            ...
            // Check if there is a duplicate ruleId.
            Assert2.isTrueOf(rules.stream().map(RuleSpec::getRuleId).distinct().count()
                    == rules.size(), "Duplicate ruleId in rules");
        }
    }
    ...
    public static class RuleSpec {
        ...
        public void validate() {
            hasTextOf(ruleId, "ruleId");
            hasTextOf(recordFilter, "recordFilter");
        }
    }
