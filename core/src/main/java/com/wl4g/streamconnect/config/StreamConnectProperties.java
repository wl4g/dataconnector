...
import com.wl4g.streamconnect.config.configurator.DefaultStreamConnectConfigurator.DefaultConfiguratorProvider;
...
public class StreamConnectProperties implements InitializingBean {
    ...
    public static class ConnectorProperties {
        ...
        @NotNull
        private @Default ProcessStreamConfig executor = new ProcessStreamConfig();
