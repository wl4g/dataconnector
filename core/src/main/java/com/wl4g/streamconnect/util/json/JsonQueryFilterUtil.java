...
/**
 * The {@link JsonQueryFilterUtil}
 *
 * @author James Wong
 * @since v1.0
 **/
public abstract class JsonQueryFilterUtil {

    public static List<JsonNode> map(String json, String path) throws JsonQueryException {
