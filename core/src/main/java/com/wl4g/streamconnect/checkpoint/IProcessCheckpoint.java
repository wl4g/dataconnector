...
/**
 * The {@link IProcessCheckpoint}
 *
 * @author James Wong
 * @since v1.0
 **/
public interface IProcessCheckpoint extends IStreamConnectSpi {

    // TODO remove, add ISubscribeQoS?
    CheckpointQoS getQoS();

    int getQoSMaxRetries();

    long getQoSMaxRetriesTimeout();

    int getProducerMaxCountLimit();
