        ...
        return new PointWriter() {
            ...
            public WritePointResult writeAsync(ConnectorConfig connectorConfig,
                ...
                try {
                    ...
                    readPointListener.onMessage((List<? extends MessageRecord<String, Object>>) record.getRecord(),
                            DEFAULT_ACKNOWLEDGE);
                } catch (Throwable ex) {
                    throw new StreamConnectException(ex);
                }
                return new WritePointResult(record, null, FUTURE_SUCCESS, retryTimes);
            }
