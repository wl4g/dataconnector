...
@Setter
@Slf4j
public abstract class AbstractQoS extends NamedStreamConnectSpi implements IQoS {
    ...
    public void retryIfFail(ConnectorConfig connectorConfig,
        ...
        if (canRetry(connectorConfig, retryTimes)) {
            ...
            try {
                ...
                throw new StreamConnectException(String.format("Failed to do retry of times: %s, intervalMs : %s",
