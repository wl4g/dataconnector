...
/**
 * Strictly not lost, forever retries if it fails.
 *
 * @author James Wong
 * @since v1.0
 **/
@Getter
@Setter
public class AlwaysAttemptsQoS extends AbstractQoS {

    public static final String TYPE_NAME = "ALWAYS_ATTEMPTS_QOS";
