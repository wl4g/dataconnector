...
@Setter
@Slf4j
public abstract class AbstractProcessFilter extends ComplexProcessHandler
        implements IProcessFilter {
    private final StreamContext context;

    public AbstractProcessFilter(@NotNull StreamContext context) {
