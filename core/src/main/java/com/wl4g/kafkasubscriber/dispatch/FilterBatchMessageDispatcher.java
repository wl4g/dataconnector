            ...
            synchronized (this) {
                if (Objects.isNull(subscribeFilter)) {
                    try {
                        ...
                        this.subscribeFilter = context.getBean(pipelineConfig.getFilter()
                                .getCustomFilterBeanName(), ISubscribeFilter.class);
        ...
        if (Objects.isNull(tenantProducers)) {
            synchronized (this) {
                if (Objects.isNull(tenantProducers)) {
                    ...
                    final KafkaProducerBuilder builder = new KafkaProducerBuilder(pipelineConfig.getFilter()
