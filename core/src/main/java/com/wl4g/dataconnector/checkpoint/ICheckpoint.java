 ...
 * @since v1.0
 **/
public interface ICheckpoint extends IDataConnectorSpi {
    ...
    class WritePointResult {
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(channel.getId().concat(record.getKey()),
                    that.getChannel().getId().concat(that.record.getKey()));
        }
