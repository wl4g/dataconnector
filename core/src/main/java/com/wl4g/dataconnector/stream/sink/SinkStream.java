...
package com.wl4g.dataconnector.stream.sink;
...
import static com.wl4g.dataconnector.meter.DataConnectorMeter.DEFAULT_PERCENTILES;
...
public abstract class SinkStream extends AbstractStream {
    ...
    public static abstract class SinkStreamProvider extends NamedDataConnectorSpi {
