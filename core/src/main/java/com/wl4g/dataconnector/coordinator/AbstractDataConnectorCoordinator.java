...
import com.wl4g.dataconnector.exception.NoFoundChannelException;
...
/**
 * The {@link AbstractDataConnectorCoordinator}
 *
 * @author James Wong
 * @since v1.0
 **/
@Slf4j
@Getter
public abstract class AbstractDataConnectorCoordinator implements IDataConnectorCoordinator {
    ...
    protected AbstractDataConnectorCoordinator(@NotNull Environment environment,
    ...
    protected void doUpdateChannels(List<ServerInstance> instances) {
        ...
        final IShardingStrategy strategy = ofNullable(config.getDefinitions()
                ...
                .orElseThrow(() -> new DataConnectorException("No sharding strategy found."));
