...
/**
 * The {@link IDataConnectorCoordinator}
 *
 * @author James Wong
 * @since v1.0
 **/
public interface IDataConnectorCoordinator extends Runnable, Closeable {
    ...
    @ToString
    @NoArgsConstructor
    abstract class CoordinatorProvider extends NamedDataConnectorSpi {
        public abstract IDataConnectorCoordinator obtain(Environment environment,
                                                         DataConnectorConfiguration config,
                                                         IDataConnectorConfigurator customizer,
