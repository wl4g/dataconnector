...
/**
 * The {@link NoOpProcessMapperTests}
 *
 * @author James Wong
 * @since v1.0
 **/
public class NoOpProcessMapperTests {
    ...
    public void testSimpleDoMap() {
        ...
        final NoOpProcessMapper mockMapper = buildDefaultMockNoOpProcessMapper(mockChannel);
        ...
        Assertions.assertEquals("{\"name\":\"John\",\"age\":30,\"address\":{\"city\":\"New York\",\"zipcode\":\"12345\"}}",
                mockResult.getValue().toString());
    }

    public static NoOpProcessMapper buildDefaultMockNoOpProcessMapper(ChannelInfo channel) {
        final DataConnectorConfiguration mockConfig = DataConnectorMockerSetup.buildDefaultDataConnectorConfiguration();
        final NoOpProcessMapperConfig mapperConfig = new NoOpProcessMapperConfig();
        return new NoOpProcessMapper(mockConfig, mapperConfig, channel.getId(),
