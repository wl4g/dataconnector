...
public class ProcessStreamTests {
    ...
    static MessageRecord<String, Object> buildMockMessageRecord(String key, String tenantId) {
    ...
    static StreamConnectProperties buildMockStreamConnectProperties() {
        return new StreamConnectProperties() {
            ...
            @Override
            public ConfiguratorProvider getConfigurator() {
    ...
    public void testSourceAndProccessStreaming() {
        List<MessageRecord<String, Object>> mockRecords = new ArrayList<>();
        ...
        StreamContext mockContext = new StreamContext(mockEnvironment, mockConfiguration, mockConnectorConfig, mockRegistry, mockBootstrap);
