...
public class ComplexProcessChainTests {
    ...
    public void testComplexProcessChainEnd() {
        ...
        final StandardExprProcessFilter filter1 = new StandardExprProcessFilter() {
            @Override
            public boolean doFilter(ChannelInfo channelInfo, AbstractStream.MessageRecord<String, Object> record) {
                filterTracing.add(1);
        ...
        filter1.updateMergeConditions(singletonList(ChannelInfo
                .builder()
                .settingsSpec(ChannelInfo.SettingsSpec.builder().policySpec(ChannelInfo.PolicySpec.builder()
                                .rules(singletonList(ChannelInfo.RuleSpec
                                        .builder()
        ...
        final NoOpProcessMapper mapper1 = new NoOpProcessMapper() {
            @Override
            public AbstractStream.MessageRecord<String, Object> doMap(ChannelInfo channel,
                                                                      AbstractStream.MessageRecord<String, Object> record) {
                mapperTracing.add(1);
        ...
        final AbstractStream.MessageRecord<String, Object> record = new AbstractStream.MessageRecord<String, Object>() {
        ...
        final ComplexProcessChain.ComplexProcessResult mockResult = mockChain.process(ChannelInfo.builder().build(), record);
