...
import com.wl4g.streamconnect.util.KafkaProducerBuilder;
...
import static com.wl4g.streamconnect.base.AssertionApplicationIT.IT_DATA_MOCKERS_TIMEOUT;
        ...
        try {
            for (int i = 0, shardingItems = total / sharding; i < sharding; i++) {
                ...
                executor.execute(() -> {
                    ...
                    try (Producer<String, Object> producer = new KafkaProducerBuilder(props)
                            .buildProducer()) {
