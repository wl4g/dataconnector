...
import com.wl4g.streamconnect.integration.base.GenericITContainerManager;
...
public class QuickStartApplicationIT extends AssertionSpringApplicationIT {
    ...
    private static final GenericITContainerManager containerManager = new GenericITContainerManager(QuickStartApplicationIT.class) {
        @Override
        protected void initMiddlewareContainers(@NotNull Supplier<CountDownLatch> startedLatchSupplier,
            ...
            mwContainers.put(KAFKA_CLUSTER_01, buildBitnamiKafka35Container(startedLatchSupplier, 59092, 9092, kafkaEnv));
            mwContainers.put(KAFKA_CLUSTER_02, buildBitnamiKafka35Container(startedLatchSupplier, 59093, 9092, kafkaEnv));
    ...
    protected void registerApplicationEnvironment() {
        System.setProperty("IT_SOURCE_KAFKA_SERVERS_01", containerManager.getKafkaClusterServers(KAFKA_CLUSTER_01));
        System.setProperty("IT_SOURCE_KAFKA_SERVERS_02", containerManager.getKafkaClusterServers(KAFKA_CLUSTER_02));
        System.setProperty("IT_CHECKPOINT_KAFKA_SERVERS_01", containerManager.getKafkaClusterServers(KAFKA_CLUSTER_01));
        System.setProperty("IT_SINK_KAFKA_SERVERS_01", containerManager.getKafkaClusterServers(KAFKA_CLUSTER_01));
        System.setProperty("IT_SINK_KAFKA_SERVERS_02", containerManager.getKafkaClusterServers(KAFKA_CLUSTER_02));
        System.setProperty("IT_SINK_ROCKETMQ_SERVERS_01", containerManager.getRocketMQClusterServers(ROCKETMQ_CLUSTER_01));
        System.setProperty("IT_COORDINATOR_KAFKA_SERVERS_01", containerManager.getKafkaClusterServers(KAFKA_CLUSTER_01));
    }
    ...
    protected List<Runnable> doRegisterAssertionTasks(CountDownLatch assertionLatch) {
        ...
        tasks.add(containerManager.buildKafkaConsumingAssertionRunner(assertionLatch, containerManager.getKafkaClusterServers(KAFKA_CLUSTER_01),
        ...
        tasks.add(containerManager.buildKafkaConsumingAssertionRunner(assertionLatch, containerManager.getKafkaClusterServers(KAFKA_CLUSTER_02),
        ...
        tasks.add(containerManager.buildRocketMQConsumingAssertionRunner(assertionLatch, containerManager.getRocketMQClusterServers(ROCKETMQ_CLUSTER_01),
