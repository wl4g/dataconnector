...
public class JDBCSourceStream extends SourceStream {
    ...
    public JDBCSourceStream(@NotNull final StreamContext context,
    ...
    public static class JDBCSourceStreamProvider extends SourceStreamProvider {
        public static final String TYPE_NAME = getStreamProviderTypeName(JDBCSourceStreamConfig.TYPE_NAME);
        ...
        @Override
        public JDBCSourceStreamBootstrap create(@NotNull final StreamContext context,
