...
public class KafkaSinkStream extends SinkStream {
    ...
    public KafkaSinkStream(@NotNull final StreamContext context,
        ...
        this.basedMetricsTags = Arrays.asList(
                DataConnectorMeter.MetricsTag.CONNECTOR, getConnectorConfig().getName(),
                DataConnectorMeter.MetricsTag.TOPIC, sinkStreamConfig.getTopic(),
                DataConnectorMeter.MetricsTag.QOS, sinkStreamConfig.getQos(),
                DataConnectorMeter.MetricsTag.CHANNEL, getChannel().getId());
    ...
    public static final Map<String, Object> DEFAULT_CONNECT_PROPS = unmodifiableMap(new HashMap<String, Object>() {
        {
